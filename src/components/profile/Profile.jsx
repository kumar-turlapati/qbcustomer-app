...
import { SideArrowIcon, OrderIcon, WishListIcon, LedgerIcon } from '../../icons/Icons';
...
const catalogue = [
  ...
  },
  {
    ...
    icon: <WishListIcon style={{ width: 20, height: 20, marginTop: 35, marginLeft: 8 }} />
  },
  {
    id: 3,
    title: 'Ledger',
    description: 'Check your transaction & Balance',
    icon: <LedgerIcon style={{ width: 24, height: 26, marginTop: 30, marginLeft: 8 }} />
  },
]
